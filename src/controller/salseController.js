const { CalculateTotalService, QuantityByProductService, TopProductsService, AvgPriceService, RevnueByMonthService, HighestQtySoldService, DepartmentSalaryExpService } = require("../services/salseService")
